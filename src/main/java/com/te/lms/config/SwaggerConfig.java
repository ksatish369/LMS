...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("LMS", "Learning Management System", "1.0", "Terms of Service", new Contact("K.Satish", "nothing", "ksatis@gmail.com"), "license", "api license",Collections.emptyList());
	}
}
